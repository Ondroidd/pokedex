...
type cliCommand struct {
	name        string
	description string
	callback    func(*API_locations, *pokecache.Cache, string, map[string]API_pokemon) error
}
...
func init() {
	commands = map[string]cliCommand{
		...
		"inspect": {
			name:        "inspect",
			description: "Take a closer look at a pokemon",
